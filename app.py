...
win=Tk()
win.title('STARTUP PROFIT PREDICTION SYSTEM')
win.config(bg='gray')
...
l0=Label(win,text='STARTUP PROFIT PREDICTION SYSTEM',width=40,bg='white',
         fg='black',bd=5,relief='ridge',font=('times in roman',18,'bold'))
